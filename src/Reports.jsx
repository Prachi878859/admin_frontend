...
const Reports = () => {
  ...
  const fetchPowerStations = async () => {
    try {
      ...
      if (response.data && response.data.success) {
        let stationsData = response.data.data || [];
  ...
  const filterStations = useCallback(() => {
    ...
    // Maintain the sort order (newest first) after filtering
    filtered.sort((a, b) => {
      const dateA = a.created_at ? new Date(a.created_at) : new Date(0);
      const dateB = b.created_at ? new Date(b.created_at) : new Date(0);
      return dateB - dateA;
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      {/* Power Stations Table */}
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        <div id="table-top" className="p-6 border-b border-gray-200">
          <h3 className="text-xl font-bold text-gray-900">
            Power Stations 
          </h3>
          <p className="text-sm text-gray-500 mt-1">
            {loading ? 'Loading...' : `Showing ${currentItems.length} of ${filteredStations.length} stations (Page ${currentPage} of ${totalPages || 1})`}
          </p>
          {activeTab !== 'all' && (
            <p className="text-sm text-blue-600 mt-1">
              Filtered by: {activeTab.replace('-', ' ')}
        ...
        {!loading && filteredStations.length > 0 && (
          <div className="px-6 py-4 bg-white border-t border-gray-200">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="text-sm text-gray-500">
                Showing {((currentPage - 1) * itemsPerPage) + 1} to {Math.min(currentPage * itemsPerPage, filteredStations.length)} of {filteredStations.length} entries
              </div>
      ...
      {/* Station Details Modal - Updated with two cards per column */}
      {showDetailsModal && selectedStation && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-xs flex items-center justify-center p-4 z-50" onClick={closeModal}>
          <div 
            className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden transform transition-all duration-300 scale-100 opacity-100"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="px-8 py-6 bg-gradient-to-r from-blue-500 to-blue-600">
            ...
            {/* Content - Two cards per column with equal height */}
            <div className="px-8 py-6 bg-gray-50 overflow-y-auto max-h-[calc(90vh-120px)]">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Column 1: Station Information Cards */}
                <div className="flex flex-col gap-6">
                  {/* Basic Information Card */}
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex-1 min-h-[250px]">
                  ...
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex-1 min-h-[250px]">
                    <div className="p-5 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-purple-100">
                      <h4 className="font-semibold text-gray-900 flex items-center">
                    ...
                    <div className="p-5">
                      <div className="space-y-4">
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-sm text-gray-600">Station ID:</span>
                          <span className="text-sm font-medium text-gray-900 bg-gray-100 px-2 py-1 rounded">
                            {selectedStation.id || 'N/A'}
                          </span>
                        </div>
                        <div className="flex justify-between items-center py-2">
                ...
                {/* Column 2: Technical Information Cards */}
                <div className="flex flex-col gap-6">
                  {/* Capacity Card */}
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex-1 min-h-[250px]">
                    ...
                    <div className="p-5">
                      <div className="space-y-4">
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-sm text-gray-600">Plant MCR:</span>
                          <span className="text-sm font-semibold text-gray-900">
                            {formatNumber(selectedStation.plant_mcr)} <span className="text-xs text-gray-500">MWh</span>
                          </span>
                        </div>
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-sm text-gray-600">Heat Rate:</span>
                          <span className="text-sm font-medium text-gray-900">
                            {formatNumber(selectedStation.heat_rate_value)}
                          </span>
                        </div>
                    ...
                    <div className="p-5">
                      <div className="space-y-4">
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-sm text-gray-600">Pipe Diameter (D2):</span>
                          <span className="text-sm font-medium text-gray-900">
                            {selectedStation.pipe_dia_d2 || 'N/A'} <span className="text-xs text-gray-500">{selectedStation.pipe_dia_unit || ''}</span>
                          </span>
                        </div>
                        <div className="flex justify-between items-center py-2">
                          <span className="text-sm text-gray-600">T2P:</span>
                ...
                {/* Column 3: Financial Information Cards */}
                <div className="flex flex-col gap-6">
                  {/* Financial Card */}
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex-1 min-h-[250px]">
                    ...
                    <div className="p-5">
                      <div className="space-y-4">
                        ...
                        <div className="flex justify-between items-center py-2 border-b border-gray-100">
                          <span className="text-sm text-gray-600">Sell Price/MWh:</span>
                        ...
                        {selectedStation.custom_currency && selectedStation.production_cost_currency === 'custom' && (
                          <div className="flex justify-between items-center py-2">
                            <span className="text-sm text-gray-600">Custom Currency:</span>
                            <span className="text-sm font-medium text-gray-900">
                              {selectedStation.custom_currency}
                            </span>
                          </div>
                  ...
                  {/* Margin Card */}
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex-1 min-h-[250px]">
                    <div className="p-5 border-b border-gray-200 bg-gradient-to-r from-yellow-50 to-yellow-100">
                      <h4 className="font-semibold text-gray-900 flex items-center">
                    ...
                    <div className="p-5">
                      <div className="space-y-4">
                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200">
                          <div className="flex justify-between items-center">
                            <span className="text-sm font-medium text-blue-800">Margin per MWh:</span>
                            <span className={`text-lg font-bold ${parseFloat(selectedStation.sell_price_per_mwh || 0) > parseFloat(selectedStation.production_cost || 0)
                              ? 'text-green-600'
                              : 'text-red-600'
                              }`}>
                              {formatCurrency(
                ...
                {/* Additional Technical Parameters Card - Full width at bottom */}
                <div className="lg:col-span-3 flex flex-col">
                  <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                    <div className="p-5 border-b border-gray-200 bg-gradient-to-r from-teal-50 to-teal-100">
                      <h4 className="font-semibold text-gray-900 flex items-center">
                    ...
                    <div className="p-5">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <span className="text-xs text-gray-500 block mb-1">P1</span>
                          <span className="text-sm font-medium text-gray-900">
                            {selectedStation.p1 || 'N/A'} {selectedStation.p1_unit || ''}
                          </span>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <span className="text-xs text-gray-500 block mb-1">T1</span>
                          <span className="text-sm font-medium text-gray-900">
                            {selectedStation.t1 || 'N/A'} {selectedStation.t1_unit || ''}
                          </span>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <span className="text-xs text-gray-500 block mb-1">P2</span>
                          <span className="text-sm font-medium text-gray-900">
                            {selectedStation.p2 || 'N/A'}
                          </span>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <span className="text-xs text-gray-500 block mb-1">TCRH</span>
                          <span className="text-sm font-medium text-gray-900">
                            {selectedStation.tcrh || 'N/A'}
                          </span>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <span className="text-xs text-gray-500 block mb-1">W CRH</span>
                          <span className="text-sm font-medium text-gray-900">
                            {selectedStation.w_crh || 'N/A'} {selectedStation.w_crh_unit || ''}
                          </span>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <span className="text-xs text-gray-500 block mb-1">TW</span>
                          <span className="text-sm font-medium text-gray-900">
                            {selectedStation.tw || 'N/A'}
                          </span>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <span className="text-xs text-gray-500 block mb-1">WW</span>
                          <span className="text-sm font-medium text-gray-900">
                            {selectedStation.ww || 'N/A'}
                          </span>
                        </div>
                        <div className="bg-gray-50 p-3 rounded-lg">
                          <span className="text-xs text-gray-500 block mb-1">T Mix</span>
                          <span className="text-sm font-medium text-gray-900">
                            {selectedStation.t_mix || 'N/A'}
                          </span>
                        </div>
                      </div>
                    </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="flex justify-end">
                  <button
                    onClick={closeModal}
                    className="px-6 py-2.5 text-sm font-medium text-white bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 rounded-lg transition-all duration-200 flex items-center shadow-md hover:shadow-lg"
                  >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                    </svg>
